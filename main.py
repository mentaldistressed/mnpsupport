...
from handlers import fileid, start, handle_message, answer_ticket, change_ticket_status, view_tickets, button_callback, history, handle_photo, ansid, handle_video, reboot, block, stats, edit, hhelp, check_tickets, quick_answer_ticket, qinfo, check_block, start_flood, stop_flood
import os
import threading
import time
import sys
...
def main():
    ...
    dispatcher.add_handler(CommandHandler('s1flood', start_flood))
    dispatcher.add_handler(CommandHandler('s2flood', stop_flood))
